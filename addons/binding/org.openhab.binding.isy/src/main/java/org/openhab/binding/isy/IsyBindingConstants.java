...
public class IsyBindingConstants {
    ...
    public final static String CHANNEL_BRIDGE_LAST_UPDATE = "last_status_update";
    public final static String CHANNEL_BRIDGE_INITIATE_RECONNECT = "initiate_reconnect";
